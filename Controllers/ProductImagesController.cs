...
namespace Vendora.Controllers
{
    ...
    public class ProductImagesController : ControllerBase
    {
        ...
        public async Task<ActionResult<ProductImage>> PostProductImage(ProductImage productImage)
        {
            ...
            return CreatedAtAction("GetProductImage", new { id = productImage.image_id }, productImage);
        }
        ...
        {
            return _context.ProductImages.Any(e => e.image_id == id);
        }
    }
}
