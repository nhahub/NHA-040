...
namespace Vendora.Controllers
{
    ...
    public class ProductVariantsController : ControllerBase
    {
        ...
        {
            if (id != productVariant.variant_id)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<ProductVariant>> PostProductVariant(ProductVariant productVariant)
        {
            ...
            return CreatedAtAction("GetProductVariant", new { id = productVariant.variant_id }, productVariant);
        }
        ...
        {
            return _context.ProductVariants.Any(e => e.variant_id == id);
        }
    }
}
